...
public class ConnectWindow extends JFrame {
	...
	private ConnectionHandleTCP _mainConnectionHandler;

	/**
	 * Create the frame.
	 */
	public ConnectWindow(ConnectionHandleTCP mainConnectionHandler) {
		...
		textField.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent arg0) {
				if(arg0.getKeyCode() == KeyEvent.VK_ENTER) {
					_mainConnectionHandler.connect(textField.getText(), 1337, "Test");
					textField.setText("");
				}
			}
		});
